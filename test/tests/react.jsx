...
describe('react renderer cases', () => {
    ...
    it('should render a function element as a React element with a prop', () => {
        ...
        if (!createElementCalledFunction) {
            throw new Error(`Expected React.createElement to be called with a function component`);
        }
            ...
            createElement: (el, props, ...children) => {
                if (typeof el === 'function') {
                    ...
                    if (typeof result === 'undefined') {
                        throw new TypeError(`React component should never return undefined`);
                    }

                    if (result !== null) {
                        throw new Error(`React component should always return null when blank`);
                    }
                }
            }
        };
